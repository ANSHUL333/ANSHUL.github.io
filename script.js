...
const appId = "c641c3d6169acef5584566064fb06280" 
...
const setValuesOfAir = airData => {
	...
	switch (aqi) {
		case 1:
			...
			break
			case 2:
				airStat = "(Fair) NICE LET'S GO OUTSIDE HAVE SOME FUN"
				color = "rgb(15, 134, 25)"
				break
			case 3:
				airStat = "(Moderate) NORMAL AIRSTA CAN GO OUTSIDE "
				color = "rgb(201, 204, 13)"
				break
			case 4:
				airStat = "(Poor) TAKE PRECAUTIONS"
				color = "rgb(204, 83, 13)"
				break
		case 5:
			airStat = "(Very Poor) HARMFUL FOR HEALTH TAKE PRECAUTIONS   "
			color = "rgb(209, 13, 13)"
			break
		default:
			airStat = "Unknown"
